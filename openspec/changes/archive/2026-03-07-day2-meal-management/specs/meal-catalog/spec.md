...
The system SHALL allow the user to tap a meal in the catalog grid to open the meal detail screen.

#### Scenario: Tap a meal
- **WHEN** the user taps a meal card in the catalog grid
- **THEN** the system navigates to the meal detail screen for that meal
